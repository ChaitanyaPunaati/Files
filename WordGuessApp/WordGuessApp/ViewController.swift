...
//  WordGuessApp
//
//  Created by Punaati,Chaitanya on 2/22/22.
//
...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var lettertEntered: UITextField!
    ...
    override func viewDidLoad() {
        ...
        // To disable the check button in the beginning
        ...
        // To get the first hint from the array
    ...
    @IBAction func CheckButtonClicked(_ sender: UIButton) {
        ...
        var letter = lettertEntered.text!
    ...
    @IBAction func enterLabelChanged(_ sender: UITextField) {
        ...
        var textEnterd = lettertEntered.text!;
        ...
        lettertEntered.text = textEnterd
